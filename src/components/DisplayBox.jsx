    ...
    if (props.origin === "Übersicht") {
        ...
        return (
            <section className="section">
                <div className="hero-body">
                    {props.ads && [...props.ads.values()].map(ad => <SavedAd key={ad.id} ad={ad} meineId={props.meineId} deleteSavedAd={(id) => { props.deleteSavedAd(id) }} writeMessage={(adId,userId)=>{props.writeMessage(adId,userId)}}/>)}
                </div>
            </section>
        )
